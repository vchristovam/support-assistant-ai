...
export const BENCHMARK_SUITE: BenchmarkCase[] = [
  ...
  },
  {
    id: "complex-01",
    category: "multi-step",
    query: "Identify the service with the highest error rate and find its recent deployment history",
    keyFacts: ["highest error rate", "deployment history", "service correlation"]
  }
];
